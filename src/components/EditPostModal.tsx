  ...
  return (
    <Dialog.Root open={isOpen}>
      <Dialog.Trigger asChild>
        <button
          className="hover:text-zinc-500/50"
          title="Edit post"
            ...
            <div className="flex gap-4 justify-end">
              <Dialog.Close asChild>
                <button
                  ...
                  className="text-black font-bold border border-black hover:bg-zinc-100 focus:shadow-black inline-flex h-8 items-center justify-center rounded-lg px-[33px] leading-none outline-none focus:shadow-[0_0_0_2px] transition-colors"
                >
                  Cancel
                </button>
              </Dialog.Close>
              <button
                type="submit"
                className="bg-[#47B960] text-white px-8 py-2 items-center justify-center rounded-lg font-bold leading-none focus:outline-none hover:bg-[#47B960]/80 transition-colors disabled:bg-zinc-500 disabled:cursor-not-allowed"
              >
